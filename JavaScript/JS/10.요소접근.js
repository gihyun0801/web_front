...
function classTest (){
   ...
   divs[1].style.backgroundColor = "blueviolet";
...
function tagNameTest (){
   ...
   for(let i = 0; i < tagList.length; i++){
         ...
         //tagLiest[i].innerText  : 작성된 내용을 얻어오기
...
/* target-div 속성의 값이 css-div인 요소 선택 */
